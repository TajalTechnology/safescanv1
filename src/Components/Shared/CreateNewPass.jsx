                ...
                <div className=' bg-white lg:w-5/12  h-[100vh] w-full flex  items-center justify-center'>
                    <div className='w-full px-[50px] my-16'>
                        <div className='mb-[50px]'>
                            <h1 className='text-dark-gray text-[28px] font-bold'>Create New Password</h1>
                            <p className='text-normal text-base text-info'>Please Enter Your New Password to Proceed.</p>
                        </div>
